...
public class ImgSet {
	 ...
	 * tile images.  Images must be in a directory named "game" relative to the 
	...
	private ImgSet( Display display ){
		...
		//String curr_dir = "/home/nelsoncs/eclipse/workspace/300_basic_ui/game/";
		//String curr_dir = "/home/sgk/eclipse/300_basic_ui/game/";

		if( _instance == null ) {

			String curr_dir = new String();
			curr_dir = System.getProperty("user.dir") + "/src/";
