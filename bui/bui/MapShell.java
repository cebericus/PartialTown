...
public class MapShell {
	...
	private void createStructures(Menu menu) {
		...
		Button btnCoal = null;
		menuAndButtonCreate(menu, mntmCoalPowerPlant, 'O',
		...
		Button btnGas = null;
		menuAndButtonCreate(menu, mntmNaturalGasPlant, 'N',
		...
		menuAndButtonCreate(menu, mntmPark, 'K', "Parks and Recreation", 6,
		...
		menuAndButtonCreate(menu, mntmPoliceStation, 'P', "Police Station",
		...
		Button btnRoad = null;
		menuAndButtonCreate(menu, mntmRoad, 'A', "Roads", 6, 516, 128, 26,
				btnRoad, "Roads");
		...
		menuAndButtonCreate(menu, mntmSolarPowerArray, 'L',
		...
		menuAndButtonCreate(menu, mntmSewageTreatmentPlant, 'S',
		...
		menuAndButtonCreate(menu, mntmWindPowerFarm, 'E', "Wind Power Farm",
